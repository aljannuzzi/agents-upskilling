...
def ask_agent(query: str, agent_id: str) -> str:
    """Sends a query to the specified agent and retrieves the response text."""
    try:
        # Create a new thread
        ...
        # Iterate through messages to find the assistant's response
...
def orchestrator(query: str) -> str:
    ...
    agent_id = "asst_Rd75AJE67hMK2uqijmH9ez9D" if action == "devsquad" else "asst_UvJQHfj4eap1uggLlLTMv4sn"
